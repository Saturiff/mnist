...
private:
	Data();
	~Data();
	static void ReadNextLabel(const char[], bool);
	static void ReadNextImage(const char[], bool);
	static int offsetOfTrainLabel;
	static int offsetOfTrainImage;
	static int offsetOfTestLabel;
	static int offsetOfTestImage;
};
